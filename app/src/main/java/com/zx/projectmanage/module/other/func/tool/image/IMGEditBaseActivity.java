...
import com.zx.projectmanage.module.other.func.tool.image.view.IMGView;
...
abstract class IMGEditBaseActivity extends Activity implements View.OnClickListener,
        IMGTextEditDialogTool.Callback, RadioGroup.OnCheckedChangeListener,
...
//    private IMGTextEditDialog mTextDialog;
    ...
    public void onClick(View v) {
        ...
        if (vid == R.id.rb_doodle) {
            ...
            onDoneClick();
        } else if (vid == R.id.tv_image_cancel) {
            onCancelClick();
...
//        mTextDialog.show();
//
        Dialog dialog = IMGTextEditDialogTool.showDialog(this, null, this);
