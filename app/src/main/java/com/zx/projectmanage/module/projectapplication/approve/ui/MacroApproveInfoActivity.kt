...
import com.zx.projectmanage.module.projectapplication.approve.mvp.model.MacroReportInfoModel
import com.zx.projectmanage.module.projectapplication.approve.mvp.presenter.MacroReportInfoPresenter
 ...
 * 功能： 施工上报宏观审批
 */
class MacroApproveInfoActivity : BaseActivity<MacroReportInfoPresenter, MacroReportInfoModel>(), MacroReportInfoContract.View {
    //工序list
    ...
    companion object {
         ...
         * 启动器
         */
        fun startAction(activity: Activity, isFinish: Boolean, processId: String, projectId: String, subProject: String, assessmentId: String) {
    ...
    private fun initTab(detailedList: List<ProjectProcessInfoBean.DetailedListBean?>?) {
        ...
        if (detailedList != null) {
            ...
            for (s in detailedList) {
                ...
                bundle.putString("subProject", subProject)
