...
import com.zx.projectmanage.module.projectapplication.approve.func.tool.setHintKtx
import com.zx.projectmanage.module.projectapplication.approve.bean.ReportSubListBean
import com.zx.projectmanage.module.projectapplication.approve.func.adapter.ApproveChildListAdapter
import com.zx.projectmanage.module.projectapplication.approve.mvp.contract.ApproveReportChildContract
import com.zx.projectmanage.module.projectapplication.approve.mvp.model.ApproveReportChildModel
import com.zx.projectmanage.module.projectapplication.approve.mvp.presenter.ApproveReportChildPresenter
 ...
 * 功能： 项目列表
 */
class ApproveReportChildActivity : BaseActivity<ApproveReportChildPresenter, ApproveReportChildModel>(), ApproveReportChildContract.View {
    private var list: MutableList<ReportSubListBean> = arrayListOf<ReportSubListBean>()
    private val reportListAdapter = ApproveChildListAdapter(list)
    ...
    lateinit var assessmentId: String
    ...
    companion object {
         ...
         * 启动器
         */
        fun startAction(activity: Activity, isFinish: Boolean, projectId: String, projectName: String, assessmentId: String) {
            val intent = Intent(activity, ApproveReportChildActivity::class.java)
...
//                refresh(searchText.toString())
        ...
        reportListAdapter.setOnItemClickListener { adapter, view, position ->
            val item = adapter.data as ReportSubListBean
